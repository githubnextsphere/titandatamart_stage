view: tbeprod_vw_chairman_bonus_manager_lines {
  derived_table: {
    sql: select
      ...
      fc."period"
      from prodaggregation_sql.fact_cblines fc
      Join prod_as400.dim_member dm on dm.distributorid =fc.frontlineid
      Join prod_as400.dim_member cb  on cb.distributorid =fc.cb_id
      WHERE
