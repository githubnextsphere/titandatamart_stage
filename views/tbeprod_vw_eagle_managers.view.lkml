view: tbeprod_vw_eagle_managers {
  derived_table: {
    sql: SELECT   fe.DistributorId as "FBO ID",
      ...
      dm.homecompanycode
      FROM   prodaggregation_sql.fact_emqualification fe
      inner join prod_as400.dim_member dm
      ...
      dm.homecompanycode
      FROM   prodaggregation_sql.fact_emqualification fe
      inner join prod_as400.dim_sponsor ds
  ...
  dimension: fbo_id {
    ...
    dimension: total_cc_qc {
      ...
      value_format: "#,##0.000"
      html: {% if value != 0 %}
          <a href="https://foreverliving.looker.com/dashboards-next/6218?FBO+ID={{fbo_id._value}}&Period={{_filters['tbeprod_vw_eagle_managers.parameter_year']}}" target="_blank"><font color="blue" style="white-space: nowrap;"> <u> {{ rendered_value  }} </u> </font></a>
          {% else %}
          {{rendered_value}}
          {% endif %} ;;
    }
  ...
  dimension: min_required_em_lines_to_qualify {
    ...
    dimension: em_lines {
      ...
      html:
      {% if value != 0 %}
        <a href="https://foreverliving.looker.com/dashboards-next/6224?FBO+ID={{fbo_id._value}}&Period={{_filters['tbeprod_vw_eagle_managers.parameter_year']}}" target="_blank"><font color="blue" style="white-space: nowrap;"> <u> {{ rendered_value  }} </u> </font></a>
      {% else %}
        {{rendered_value}}
      {% endif %} ;;
    }
    ...
    dimension: em_count {
      ...
      html:
          {% if value != 0 %}
          <a href="https://foreverliving.looker.com/dashboards-next/6245?FBO+ID={{fbo_id._value}}&Period={{_filters['tbeprod_vw_eagle_managers.parameter_year']}}" target="_blank"><font color="blue" style="white-space: nowrap;"> <u> {{ rendered_value  }} </u> </font></a>
          {% else %}
          {{rendered_value}}
          {% endif %} ;;
    }
    ...
    dimension: active_all_mos {
      ...
      html:
          {% if value != 0 %}
          <a href="https://foreverliving.looker.com/dashboards-next/6341?FBO+ID={{fbo_id._value}}&Period={{_filters['tbeprod_vw_eagle_managers.parameter_year']}}&Qualifying+Country={{qualifying_country._value}}" target="_blank"><font color="blue" style="white-space: nowrap;"> <u> {{ rendered_value  }} </u> </font></a>
          {% else %}
          {{rendered_value}}
          {% endif %} ;;
    }
    ...
    dimension: new_sup_count {
      ...
      html:
          <a href="https://foreverliving.looker.com/dashboards-next/6244?FBO+ID={{fbo_id._value}}&Period={{_filters['tbeprod_vw_eagle_managers.parameter_year']}}" target="_blank"><font color="blue" style="white-space: nowrap;"> <u> {{ rendered_value  }} </u> </font></a> ;;
    }
